...
import drlugha.user_app.dto.Language;
import drlugha.user_app.dto.SourceLanguage;
import drlugha.user_app.entity.Translation;
import drlugha.user_app.service.TranslationService;
...
public class TranslationController {
    ...
    public String getTargetLanguages() {
        ...
        targetLanguages.add(new Language(7, 0, "Kamba", 7, "Kamba", "kam", "kam"));
    ...
    public String getSourceLanguages() {
        ...
        sourceLanguages.add(new SourceLanguage(7, 0, "Kamba","Kamba", "kam", "kam"));
